                    ...
                    >
                        ...
                        <div className='txt'>
                            ...
                            <p className='info' data-aos="fade-left" data-aos-offset="500" data-aos-duration="500">
                                ...
                                어디에서도 잘 보이는 반응형, 웹 접근성과 웹 표준을 고려한 정보에 맞는 의미 있는 태그들을 사용하고, 디자인을 입히기 위한 유지 보수에 적합한 스타일 시트를 사용하며, 사용자 등장에 반응하기 위한 동적인 JS를 구현하는 등 효율적이고 제대로 된 정보를 웹페이지를 통하여 전달할 수 있습니다.
                                <br/><br/>
                                더 나아가 Vue나 React의 React/TypeScript 등 프레임워크 환경에서 컴포넌트 단위의 마크업 작업을 능숙하게 할 수 있어요. 
                                <br/><br/>또한, LLM 기반 AI 어시스턴트를 통해 UI/UX 기획, 콘텐츠 생성, 코드 디버깅, 문서 자동화까지 전 영역을 효율화하고 있습니다.
                                <br/>프롬프트 엔지니어링을 기반으로 모델 응답을 최적화하며 실제 개발 및 유지보수 업무에서 생산성을 체계적으로 향상시키고 있습니다.
                                <br/><br/>
